...
INSERT INTO `beer` 
(`ID_beer`, `name`, `location`, `ID_color`, `strength`, `ID_taste`, `brewery`, `ID_category`, `ID_hops`, `ID_grains`, `IBU`, `clarity`, `calories`, `carbohydrates`) VALUES
(1, '1664 Kronenbourg', 'Strasbourg, France', 3, '6.00', 2, 'Kronenbourg', 2, 1, 1, 1, 1, 1, 1),
(2, 'Grimbergen', 'Waarlos, Belgium', 2, '6.40', 2, 'Maes', 3, 1, 1, 1, 1, 1, 1),
(3, '3 monts', 'St Sylvestre Cappel, France', 3, '4.80', 2, 'St Sylvestre', 8, 1, 1, 1, 1, 1, 1),
(4, 'Adelscott', 'Schiltigheim, France', 4, '6.60', 1, 'Fisher', 8, 1, 1, 1, 1, 1, 1);
